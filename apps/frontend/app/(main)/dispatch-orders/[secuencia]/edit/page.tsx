...
interface EditDispatchOrderPageProps {
  params: Promise<{
    secuencia: string;
  }>;
}

export default async function EditDispatchOrderPage({
  params,
}: EditDispatchOrderPageProps) {
  ...
  return (
    ...
    >
      <DispatchOrderForm mode="edit" sequence={Number(secuencia)} />
    </Suspense>
  );
}
