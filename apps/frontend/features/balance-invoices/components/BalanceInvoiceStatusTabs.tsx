...
import { AlertCircle, Ban, CheckCircle2, CircleDot } from "lucide-react";
import type { BalanceInvoiceTab } from "../hooks/useBalanceInvoiceListParams";

const TAB_CONFIG: {
  value: BalanceInvoiceTab;
  label: string;
...
export function BalanceInvoiceStatusTabs() {
  return (
    <TabsList
      variant="default"
