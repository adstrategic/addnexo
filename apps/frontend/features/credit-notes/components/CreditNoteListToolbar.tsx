...
interface CreditNoteListToolbarProps {
  searchTerm: string;
...
export function CreditNoteListToolbar({
  searchTerm,
  onSearchChange,
  onClearFilters,
  hasActiveFilters,
}: CreditNoteListToolbarProps) {
  return (
    <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
      <div className="relative min-w-0 flex-1">
        ...
        <Input
          ...
          placeholder="Search by document number, client, or invoice..."
