...
interface DispatchOrderDocumentListProps {
  documents: DispatchOrderDocument[];
}

export function DispatchOrderDocumentList({
  documents,
}: DispatchOrderDocumentListProps) {
  const [documentToView, setDocumentToView] =
    useState<DispatchOrderDocument | null>(null);
