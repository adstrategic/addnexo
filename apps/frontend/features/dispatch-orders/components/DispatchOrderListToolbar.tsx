...
interface DispatchOrderListToolbarProps {
  searchTerm: string;
...
export function DispatchOrderListToolbar({
  searchTerm,
  onSearchChange,
  onClearFilters,
  hasActiveFilters,
}: DispatchOrderListToolbarProps) {
  return (
    <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
      <div className="relative min-w-0 flex-1">
        ...
        <Input
          ...
          placeholder="Search by order number, client, or purchase order..."
