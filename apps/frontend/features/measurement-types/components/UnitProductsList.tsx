...
import { useProductsByUnit } from "../hooks/useUnits";
import {
  Card,
  CardContent,
  CardDescription,
...
interface UnitProductsListProps {
  unitId: number;
  unitName: string;
}
...
export function UnitProductsList({ unitId, unitName }: UnitProductsListProps) {
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center space-x-2">
            ...
            <span>Products using this Unit</span>
          </CardTitle>
        </CardHeader>
        <CardContent>
      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          <div>
            <CardTitle className="flex items-center space-x-2">
              <Package className="h-5 w-5" />
              <span>Products using {unitName}</span>
            </CardTitle>
            <CardDescription>
      ...
      <CardContent>
        ...
        {isLoading ? (
          ...
          <div className="text-center py-8">
            ...
            <p className="text-sm text-muted-foreground">
              No products found using this unit.
            </p>
