...
import { ArrowLeft, ArrowLeftRight, Edit, Trash2 } from "lucide-react";
...
interface MovementTypeDetailsViewProps {
  title: string;
  subtitle?: string;
...
function MovementTypeDetailsSkeleton() {
  return (
...
export function MovementTypeDetailsView({
  title,
  subtitle,
  sections,
  quickActions = [],
  ...
  onDelete,
  children,
}: MovementTypeDetailsViewProps) {
  if (isLoading) {
    return <MovementTypeDetailsSkeleton />;
  }
