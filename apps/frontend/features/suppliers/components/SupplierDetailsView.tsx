...
export function renderContactValue(
...
export function renderRetentionBadge(value: string) {
  return value === "SI" ? (
    <Badge variant="secondary">Withholding applies</Badge>
  ) : (
    <Badge variant="outline">No withholding</Badge>
  );
}

export const supplierDetailIcons = {
  user: <User className="size-4" aria-hidden />,
  mapPin: <MapPin className="size-4" aria-hidden />,
  phone: <Phone className="size-4" aria-hidden />,
  mail: <Mail className="size-4" aria-hidden />,
  file: <FileText className="size-4" aria-hidden />,
  building: <Building2 className="size-4" aria-hidden />,
};
